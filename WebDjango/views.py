...
class EnvioDetalle(DetailView):
    model = Envio
    template_name ="WebDjango/Envios/envio_detalle.html"

class EnvioCreacion(CreateView):
    model = Envio
    template_name ="WebDjango/Envios/envio_form.html"
...
class EnvioDelete(DeleteView):
    model = Envio
    template_name ="WebDjango/Envios/envio_confirm_delete.html"
    success_url = "/WebDjango/envio/list"
